        ...
        "/api/v1/auth/oauth/{provider}/callback": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "状态参数（POST 时也可在表单中提交）",
                        "name": "state",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "授权码（POST 时也可在表单中提交）",
                        "name": "code",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "提供方错误标记（如 Apple access_denied）",
                        "name": "error",
                        "in": "formData"
                    }
                ],
                "responses": {
                    "302": {
                        "description": "重定向到业务回跳地址，失败时附加 error=1"
                    },
                    "400": {
                        "description": "缺失 state 或 code，或回调失败",
                        "schema": {
                            "$ref": "#/definitions/httpx.ErrorResponse"
                        }
                    }
    ...
    "definitions": {
        ...
        "handler.RuntimeConfigResponse": {
            ...
            "properties": {
                ...
                "owo_catalog_url": {
                    "description": "OwOCatalogURL 是可选的 widget 远程表情目录地址；未配置时字段缺省。",
                    "type": "string"
                },
                "site_id": {
                    "type": "string"
