...
func newAccountDeleteTestDB(t *testing.T) *gorm.DB {
	...
	if err := database.AutoMigrate(db, &model.User{}, &model.NotificationPreferences{}, &model.Site{}, &model.SiteOrigin{}, &model.Thread{}, &model.Comment{}, &model.CommentLike{}); err != nil {
